...
const LESSON_DIALOGUES = {
    "Giao tiếp 1": {
        ...
        2: [
            ...
            { speaker: "Học sinh B", role: "b", zh: "现在早上七点半。定几点起床？", pinyin: "Xiànzài zǎoshang qī diǎn bàn. Nǐ jǐ diǎn qǐchuáng?", vi: "Bây giờ là 7 giờ rưỡi sáng. Bạn dậy lúc mấy giờ?" },
            ...
            { speaker: "Học sinh B", role: "b", zh: "真的吗？祝 tiêb sinh nhật vui vẻ nhé！", pinyin: "Zhēnde ma? Zhù nǐ shēngrì kuàilè!", vi: "Thật sao? Chúc bạn sinh nhật vui vẻ nhé!" }
        ],
        5: [
            ...
            { speaker: "Học sinh A", role: "a", zh: "我没有哥哥 và em gái，我有一个弟弟。", pinyin: "Wǒ méiyǒu gēge hé mèimei, wǒ yǒu yí gè dìdi.", vi: "Tôi không có anh trai và em gái, tôi có một em trai." },
    ...
    "Từ vựng theo chủ đề": {
        1: [
            ...
            { speaker: "Học sinh B", role: "b", zh: "你好！我是越南人。你呢？你是miễn phí vĩnh viễn人吗？", pinyin: "Nǐ hǎo! Wǒ  shì Yuènán rén. Nǐ ne? Nǐ  shì Měiguó rén ma?", vi: "Xin chào! Mình là người Việt Nam. Còn bạn? Bạn là người Mỹ phải không?" },
...
const CHAR_DATABASE = {
    ...
    "妈": { hanViet: "Ma", radical: "Nữ (女) - phụ nữ", strokes: 6, strokeSteps: ["1. Phẩy gập (撇折)", "2. Phẩy (撇)", "3. Ngang (横)", "4. Ngang gập gập móc (横折 gập gập móc)", "5. Sổ đứng (竖)", "6. Ngang (横)"] },
    ...
    "奶": { hanViet: "Nãi", radical: "Nữ (女) - phụ nữ", strokes: 5, strokeSteps: ["1. Phẩy gập (撇折)", "2. Phẩy (撇)", "3. Ngang (横)", "4. Ngang gập uốn móc (横折 gập móc)", "5. Phẩy (撇)"] },
    ...
    if (currentCourse === "Giao tiếp 1") {
        if (currentLesson === 1) {
            ...
            dialogues = [
                ...
                { q: 'Điền từ vào ô trống:<br>A: <span class="chinese-char">爸爸_______妈妈都在家 ma？</span><br>B: <span class="chinese-char">是的，họ đều ở nhà.</span>', ans: "和", opts: ["和", "有", "个", "的"] }
            ];
        }
    } else if (currentCourse === "Từ vựng theo chủ đề") {
        dialogues = [
